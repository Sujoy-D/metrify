import svgPaths from "./svg-ibypkabl85";

function Heading() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute css-ew64yg font-['Arimo:Bold',sans-serif] font-bold leading-[36px] left-[416.8px] text-[#0f172b] text-[30px] text-center top-[-3px] translate-x-[-50%]">Metrify Logo Design</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[416.34px] text-[#45556c] text-[16px] text-center top-[-1.67px] translate-x-[-50%]">Adjust algorithm weights and track price recommendations for your Shopify store</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[76px] items-start left-0 top-0 w-[832px]" data-name="Container">
      <Heading />
      <Paragraph />
    </div>
  );
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[48px] items-start left-0 top-[-6px] w-[120.229px]" data-name="Text">
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[48px] items-start left-[120.23px] top-[-6px] w-[184.188px]" data-name="Text">
...
function Container1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[304.417px]" data-name="Container">
...
function Container2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[304.417px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#45556c] text-[14px] top-[-1.33px]">AI-powered metrics for merchants</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[62px] items-start left-[92px] top-[9px] w-[304.417px]" data-name="Container">
      <Container1 />
      <Container2 />
    </div>
  );
...
function Logo() {
  return (
    <div className="absolute h-[80px] left-[217.79px] top-[48px] w-[396.417px]" data-name="Logo">
      <Container3 />
      <Container5 />
    </div>
  );
...
function Container6() {
  return (
    <div className="absolute h-[24px] left-[48px] top-[160px] w-[736px]" data-name="Container">
      <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[368.94px] text-[#62748e] text-[16px] text-center top-[-1.67px] translate-x-[-50%]">Primary Logo - Light Background</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute bg-white h-[232px] left-0 rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[140px] w-[832px]" data-name="Container">
      <Logo />
      <Container6 />
    </div>
  );
...
function Text2() {
  return (
    <div className="absolute content-stretch flex h-[32px] items-start left-0 top-[-4px] w-[80.156px]" data-name="Text">
...
function Text3() {
  return (
    <div className="absolute content-stretch flex h-[32px] items-start left-[80.16px] top-[-4px] w-[122.792px]" data-name="Text">
...
function Container8() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[202.948px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Text2 />
        <Text3 />
      </div>
...
function Container9() {
  return (
    <div className="h-[16px] relative shrink-0 w-[202.948px]" data-name="Container">
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[46px] items-start left-[60px] top-px w-[202.948px]" data-name="Container">
      <Container8 />
      <Container9 />
    </div>
  );
...
function Logo1() {
  return (
    <div className="absolute h-[48px] left-[68.52px] top-[48px] w-[262.948px]" data-name="Logo">
      <Container10 />
      <Container12 />
    </div>
  );
...
function Container13() {
  return (
    <div className="absolute h-[20px] left-[48px] top-[112px] w-[304px]" data-name="Container">
      <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[152.05px] text-[#90a1b9] text-[14px] text-center top-[-1.33px] translate-x-[-50%]">On Dark Background</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute h-[20px] left-[48px] top-[112px] w-[304px]" data-name="Container">
      <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[152.98px] text-[#e0e7ff] text-[14px] text-center top-[-1.33px] translate-x-[-50%]">On Colored Background</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="col-[2] css-3foyfs relative rounded-[16px] row-[1] self-stretch shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0" data-name="Container" style={{ backgroundImage: "linear-gradient(155.772deg, rgb(79, 57, 246) 0%, rgb(152, 16, 250) 100%)" }}>
      <Logo2 />
      <Container20 />
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute gap-[32px] grid grid-cols-[repeat(2,_minmax(0,_1fr))] grid-rows-[repeat(1,_minmax(0,_1fr))] h-[180px] left-0 top-[404px] w-[832px]" data-name="Container">
      <Container14 />
      <Container21 />
    </div>
  );
...
function Heading1() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute css-ew64yg font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-[368.45px] text-[#0f172b] text-[20px] text-center top-[-2.33px] translate-x-[-50%]">Size Variations</p>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="absolute content-stretch flex h-[24px] items-start left-0 top-[-3.33px] w-[60.115px]" data-name="Text">
...
function Text7() {
  return (
    <div className="absolute content-stretch flex h-[24px] items-start left-[60.11px] top-[-3.33px] w-[92.094px]" data-name="Text">
...
function Container23() {
  return (
    <div className="absolute h-[18px] left-[44px] top-[7px] w-[152.208px]" data-name="Container">
      <Text6 />
      <Text7 />
    </div>
  );
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[56px] items-start left-[61.21px] top-[8px] w-[196.208px]" data-name="Container">
      <Logo3 />
      <Paragraph1 />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-[411.83px] top-0 w-[262.948px]" data-name="Container">
      <Logo4 />
      <Paragraph2 />
    </div>
  );
...
function Container34() {
  return (
    <div className="h-[20px] relative shrink-0 w-[304.417px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[153.07px] text-[#45556c] text-[14px] text-center top-[-1.33px] translate-x-[-50%]">AI-powered metrics for merchants</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[104px] items-start left-[169.79px] top-[104px] w-[396.417px]" data-name="Container">
      <Logo5 />
      <Paragraph3 />
    </div>
  );
...
function Container40() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[364px] items-start left-0 pb-0 pt-[48px] px-[48px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[616px] w-[832px]" data-name="Container">
      <Heading1 />
      <Container39 />
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute css-ew64yg font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-[367.73px] text-[#0f172b] text-[20px] text-center top-[-2.33px] translate-x-[-50%]">Icon Only</p>
    </div>
  );
}
...
function Logo6() {
  return (
    <div className="absolute left-[240px] rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[32px] top-[24px]" data-name="Logo" style={{ backgroundImage: "linear-gradient(135deg, rgb(97, 95, 255) 0%, rgb(152, 16, 250) 100%)" }}>
      <Container41 />
      <Icon13 />
    </div>
  );
...
function Logo7() {
  return (
    <div className="absolute left-[320px] rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[48px] top-[16px]" data-name="Logo" style={{ backgroundImage: "linear-gradient(135deg, rgb(97, 95, 255) 0%, rgb(152, 16, 250) 100%)" }}>
      <Container42 />
      <Icon15 />
    </div>
  );
...
function Logo8() {
  return (
    <div className="absolute left-[416px] rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[80px] top-0" data-name="Logo" style={{ backgroundImage: "linear-gradient(135deg, rgb(97, 95, 255) 0%, rgb(152, 16, 250) 100%)" }}>
      <Container43 />
      <Icon17 />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[236px] items-start left-0 pb-0 pt-[48px] px-[48px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[1012px] w-[832px]" data-name="Container">
      <Heading2 />
      <Container44 />
    </div>
  );
...
function Container46() {
  return (
    <div className="h-[1248px] relative shrink-0 w-full" data-name="Container">
      <Container />
      <Container7 />
      <Container22 />
      <Container40 />
...
export default function LogoDesignForPriceMetric() {
  return (
    <div className="content-stretch flex flex-col items-start pb-0 pt-[32px] px-[32px] relative size-full" data-name="Logo Design for Price Metric" style={{ backgroundImage: "linear-gradient(124.33deg, rgb(248, 250, 252) 0%, rgb(241, 245, 249) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Container46 />
    </div>
  );
}